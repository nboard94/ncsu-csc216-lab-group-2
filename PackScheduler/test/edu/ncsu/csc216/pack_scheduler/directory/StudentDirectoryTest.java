...
public class StudentDirectoryTest {
	...
	public void testLoadStudentsFromFile() {
		...
		//Test invalid file
		try {
			sd.loadStudentsFromFile("does_not_exist.txt");
			fail();
		} catch(IllegalArgumentException e) {
			assertEquals("Unable to read file does_not_exist.txt", e.getMessage());
		}
	}
