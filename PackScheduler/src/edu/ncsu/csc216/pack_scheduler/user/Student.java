...
public class Student implements Comparable<Student> {
	...
	/**
	 * Calculates the Student's hashCode
	...
	/**
	 * Compares two Students for equality by their fields.
	...
	public int compareTo(Student s) {
		String thisStudent = this.lastName + this.firstName + this.id;
		String otherStudent = s.lastName + s.firstName + s.id;
